...
class TestPluralityVoting:
    ...
    def test_vote_plurality_basic_flow(self):
        ...
        # Required keys (subset check — voting rules may add extras).
        required = {
            "votes",
            "winner",
            "softmax",
        ...
        # Uniform fields introduced for VoteResult typing.
        assert results["votes_matrix"].shape == (n_agents, n_cand)
        assert results["votes_per_candidate"].shape == (n_cand,)
